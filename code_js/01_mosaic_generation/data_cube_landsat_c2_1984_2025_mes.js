...
// Last modified: 20.07.2025 | Mesoamerica domain
...
var ltStack2 = vertStack.addBands(ftvB1).addBands(ftvB2).addBands(ftvB3).addBands(ftvB4).addBands(ftvB5).addBands(ftvB7)
                       ...
                       .reproject('EPSG:4326', null, 100) // ** REPROJECT DATA TO 100m RESOLUTION **
                       .toInt16();

var lt_stack_2023 = ltStack2.select(['B1_2023','B2_2023','B3_2023','B4_2023','B5_2023','B7_2023'],['B1','B2','B3','B4','B5','B7']);

var lt_stack_2024 = ltStack2.select(['B1_2024','B2_2024','B3_2024','B4_2024','B5_2024','B7_2024'],['B1','B2','B3','B4','B5','B7']);
...
var landsat_2025 = ltStack2.select(['B1_2025','B2_2025','B3_2025','B4_2025','B5_2025','B7_2025']);
...
Export.image.toAsset({'image': ltStack2.toInt16(), 'region': aoi, 'scale': 100, 'description': 'mes_lt_fitted_1984_2025',
  'assetId': 'mes_landsat_boa_fitted_r70_1984_2025_100m',
