...
// Last modified: 12.11.2025 | Ucayali, Peru domain
...
// https://code.earthengine.google.com/?scriptPath=users%2Fservirbz%2Fland_cover_change%3ALandTrendr_mes%2FLt-Change-Db_3d_100m_mes3i
// https://code.earthengine.google.com/?scriptPath=users%2Fservirbz%2Fland_cover_change%3ALandTrendr_bz%2Fbz_lt_exec_nbr_1984_2023_defor1b

// https://code.earthengine.google.com/?scriptPath=users%2Fservirbz%2Fservir_bz_prototypes%3Adata_cubes%2Fmes_data_cube_ex02b_100m_mes
// https://code.earthengine.google.com/?scriptPath=users%2Fservirbz%2Fservir_bz_prototypes%3Alc_misc_ps%2Fcdx%2Ffxn_cdx_2c_lac

// https://code.earthengine.google.com/?scriptPath=users%2Fservirbz%2Fservir_lcc%3ALandTrendr_meso%2F_exec%2Fcam_lt_exec_nbr_1984_2022_030m_1

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 
// load LandTrendr library
var ltgee = require('users/emaprlab/public:Modules/LandTrendr.js'); // run LandTrendr at 30m -> 100m option specified in reprojection

// define external parameters
//var roi = ee.Geometry.Rectangle(-76.1, 6.5, -92.5, 21.65); // Mesoamerica
//var roi = ee.Geometry.Rectangle(-88.85, 17.15, -88.63, 17.35); // central BZ
//var roi = ee.Geometry.Rectangle(-87.64, 15.87, -89.4, 18.54); // BZ
var roi = ee.Geometry.Polygon([[[-76.10317803947585, -7.115528903087553],  [-76.10317803947585, -11.537539443246652],
                                [-70.41226007072585, -11.537539443246652], [-70.41226007072585, -7.115528903087553]]], null, false);
...
var featureValue = 'pe_ucayali'; // what unique value from the above attribute field defines the study area
...
var endDay =   '10-31'; // what should the ending date of annual composite be | month-day 09-30
...
var runParams = { 
  ...
  recoveryThreshold:      0.25, // disallows for regrowth under 5 years
  pvalThreshold:          0.05,
...
Map.centerObject(aoi, 11); // center over AOI

////////////////////////////////////////////////////////////////////////////////////////////////////////////////

// Export data at 100m resolution
/*Export.image.toAsset({'image': ltStack2, 'region': aoi, 'scale': 100, 'description': 'mes_lt_fitted_1984_2023',
  'assetId': 'projects/sica/compil_imagenes/opticas/landsat_ft/mes_landsat_boa_fitted_r70_1984_2023_0523_100m',
  crs:'EPSG:4326', 'maxPixels': 1e13});
*/

Export.image.toAsset({'image': ltStack2.toInt16(), 'region': aoi, 'scale': 30, 'description': 'pe_lt_fitted_1984_2025',
  'assetId': 'projects/bz-sdg/compil_imagery/optical/landsat_ft/pe_ucayali_landsat_boa_fitted_r70_1984_2025_1112_030m',
  crs:'EPSG:4326', 'maxPixels': 1e13});

/*
// Export data at 30m resolution -> will also need to change above
Export.image.toAsset({'image': ltStack2, 'region': aoi, 'scale': 30, 'description': 'mes_lt_fitted_1984_2022',
  'assetId': 'projects/bz-sdg/compil_imagery/optical/landsat_ft/mes_landsat_boa_fitted_r70_1984_2022_0630_030m',
  'maxPixels': 1e13});
*/
