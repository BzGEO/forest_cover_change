...
var b = require('users/bzgeo/lcc:00_pkg/img_list_landsat_sma_fc__mes.js');
...
leftMap.setCenter(-88.7572, 17.2578, 8);
rightMap.setCenter(-88.7572, 17.2578, 8);
...
var title = ui.Label("Forest cover change, 1984-2025: the Mesoamerican Biological Corridor", {stretch:'horizontal',textAlign:'center',fontWeight:'bold',fontSize:'20px', color: 'green'});
...
var credits = ui.Label(
  "credits: Landsat imagery © NASA, USGS, processed with Kennedy et al. (2018)'s LandTrendr algorithm; generated by the SERVIR Science Coordination Office and last updated 20.07.2025",
{stretch:'horizontal',textAlign:'center',fontSize: '12px', color: 'gray'},
['https://code.earthengine.google.com/6af9ae5ee167a3995e7c54df62c27208']);
